...
extern "C"
{
    ...
    typedef struct
    {
        ...
        float rtd_nominal_resistance; // Resistenza nominale RTD a 0 °C in Ohm (PT100 = 100 Ohms,
                                      // PT1000 = 1000 Ohms)
        ...
        const max31865_platform_t
            *platform; // Contiene le funzioni che si interfacciano con l'hardware
    } max31865_t;
     ...
     * @param[in] reference_resistor        Valore della resistenza di riferimento presente nella
     * PCB.
     * @param[in] rtd_nominal_resistance    Valore della resistenza RTD (PT100: 100 Ohm, PT1000:
     * 1000 Ohm).
     ...
     *
     * @param[in] device                Dispositivo MAX31865.
     * @param[in] bitmask               Maschera dei bit da modificare (0: Valore inalterato, 1:
    ...
    /**
     * @brief Restituisce lo stato di conversione nel caso in cui si utilizza la modalità singola e
     * non continua.
     *
     * @param[in] device                Dispositivo MAX31865.
    ...
    /**
     * @brief Questa funzione salva nella struttura del dispositivo i puntatori delle funzioni da
     * utilizzare in caso di interrupt.
     *
     * @param[in] device                Dispositivo MAX31865.
